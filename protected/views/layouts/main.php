	...
	<div id="operation-menu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>Yii::t('operation_menu','Water Supply'), 'url'=>CController::createUrl('waterSupply/admin',array()),'visible'=>Yii::app()->user->isWRUT,'itemOptions'=>array('id'=>'watersupply-operation-icon'), 'active'=>Yii::app()->controller->id=='waterSupply'),
				array('label'=>Yii::t('operation_menu','Operative Margins'), 'url'=>CController::createUrl('sAOperativeMargin/admin',array()),'visible'=>Yii::app()->user->isWRUT,'itemOptions'=>array('id'=>'margin-operation-icon'), 'active'=>Yii::app()->controller->id=='saOperativeMargin'),
				array('label'=>Yii::t('operation_menu','Import'), 'url'=>CController::createUrl('fileUpload/upload',array()),'visible'=>Yii::app()->user->isWRUT,'itemOptions'=>array('id'=>'import-operation-icon'), 'active'=>Yii::app()->controller->id=='fileUpload'),
				array('label'=>Yii::t('operation_menu','Statistics'), 'url'=>CController::createUrl('statistics/index',array()),'visible'=>Yii::app()->user->isWRUT,'itemOptions'=>array('id'=>'statistics-operation-icon'), 'active'=>Yii::app()->controller->id=='statistics'),
				...
				array('label'=>Yii::t('operation_menu','Water Info'), 'url'=>CController::createUrl('waterInfo/index',array()),'visible'=>Yii::app()->user->isCitizen,'itemOptions'=>array('id'=>'info-operation-icon'), 'active'=>Yii::app()->controller->id=='waterInfo'),
				...
				array('label'=>Yii::t('operation_menu','Personal Wfs'),'url'=>array('wfs/index'), 'visible'=>!Yii::app()->user->isGuest, 'itemOptions'=>array('id'=>'wfs-operation-icon'), 'active'=>Yii::app()->controller->id=='wfs'),
				array('label'=>Yii::t('operation_menu','Personal Wms'),'url'=>array('wms/index'), 'visible'=>!Yii::app()->user->isGuest, 'itemOptions'=>array('id'=>'wms-operation-icon'), 'active'=>Yii::app()->controller->id=='wms'),
