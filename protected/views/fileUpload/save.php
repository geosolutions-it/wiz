...
<?php 
	...
	echo CHtml::radioButtonList('table','',
		array('Zones'=>Yii::t('generic','Zones'),
			  'WaterRequestParameters'=>Yii::t('generic','Parameters'),
			  'Formulas'=>Yii::t('generic','Formulas'),
			  'WaterSupply'=>Yii::t('generic','Water Supply'),
			  'SAOperativeMargin'=>Yii::t('generic','Operative Margin'),
		),
		array('labelOptions'=>array('style'=>'display:inline'), 
		'separator'=>'<br>',
		'onChange'=>CHtml::ajax(array('type'=>'POST', 'url'=>array('fileUpload/updateFields'), 
