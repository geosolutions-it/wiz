...
class SAOperativeMarginController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('SAOperativeMargin');
	...
	{
		$model=new SAOperativeMargin('search');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='saoperative-margin-form')
		{
