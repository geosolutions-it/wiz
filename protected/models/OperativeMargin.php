...
/**
 * This is the model class for table "operative_margin".
 *
 ...
 */
class OperativeMargin extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return OperativeMargin the static model class
	 */
