...
class Geometry extends CApplicationComponent
{
	...
	{
		//Yii::log(print_r("ST_GeomFromText('".$coordinates."',".$srid.")", true) , CLogger::LEVEL_INFO, 'ST_GeomFromText');  // DEBUG
	...
	/**
	 * Wrapper for Tranform(geometry, srid). Default SRID = 3003
	 * @param string $geometry
	 * @param integer $srid
	 */
	public static function Transform($geometry, $srid=3003)
	{
		 ...
		 */
		//Yii::log(print_r("ST_Transform(".$geometry.",".$srid.")", true) , CLogger::LEVEL_INFO, 'Transform');  // DEBUG
